...
const logo = {
    name: './AgiBot.jpg',
    link: "https://www.agibot.com/",
}
const right_items = {
    "About": {link: "https://www.agibot.com/about_Zhiyuan", name: "About Us"}
}
// 右侧更多菜单
const more_paper = {
    // "ExtDM": {
    ...
    <el-affix :offset="0" :style="{ width: '100%' }">
        ...
        <el-menu default-active="0" class="el-menu-demo" mode="horizontal" :ellipsis="false">
            ...
            <el-menu-item index="1">
                <a :href=logo.link>
                    <el-icon style="width: 200px; height: 70px; ">
                    <!-- <HomeFilled /> -->
                     <!-- <el-image :src="logo_img" class="logo"  object-fit: cover style="width: 120px; height: 30px; " /> -->
                    <el-image :src="logo.name" alt="icon"  />
                </el-icon>
                </a>
            </el-menu-item>

            <el-menu-item index="2">
                <a :href="right_items.About.link">
                    {{right_items.About.name}}
                </a>
            </el-menu-item>
            <!-- 更多栏目 -->
            <!-- <el-sub-menu index="3">
